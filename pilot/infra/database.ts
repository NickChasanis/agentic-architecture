...
try{
 ...
 // Catalog's composite foreign key depends on the shop uniqueness constraint.
 await pool.query(readFileSync(new URL('../modules/catalog/schema.sql',import.meta.url),'utf8'));
